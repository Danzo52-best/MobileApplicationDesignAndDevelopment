...
function registerTrip(e) {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql(
            query, [name, destination, description, risk, other, totalday],
            transactionSuccess,
            transactionError
        );

        function transactionSuccess(tx, result) {
            let message = `Added trip '${name}' success`;
...
function addExpense(e) {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql(
            query, [type, amount, comment, tripId],
            transactionSuccess,
            transactionError
        );
...
function updateTrip(e) {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql(
            query, [name, destination, description, risk, other, totalday, id],
            transactionSuccess,
            transactionError
        );
